...
//             {/* Sidebar */}
//             <div className="w-20 bg-white/80 backdrop-blur-sm shadow-lg flex flex-col items-center py-6">
//                 <div className="w-12 h-12 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-xl flex items-center justify-center mb-8">
...
//                         <div
//                             key={index}
//                             className={`w-12 h-12 rounded-xl flex items-center justify-center cursor-pointer transition-all duration-200 ${item.active
...
//                         <div className="w-8 h-8 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-lg flex items-center justify-center mr-3">
...
//                             className="pl-10 pr-4 py-2 w-80 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent"
//                         />
//                     </div>
//                     <button className="bg-gradient-to-r from-teal-400 to-cyan-500 text-white px-6 py-2 rounded-full flex items-center space-x-2 hover:from-teal-500 hover:to-cyan-600 transition-all duration-200 shadow-lg">
